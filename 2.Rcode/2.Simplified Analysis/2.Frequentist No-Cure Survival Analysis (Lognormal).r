...
dropbox_export_path_default <- "/Users/ido/Library/CloudStorage/Dropbox/Data Analysis/Survival Analysis of CHR-P Using a Mixture Cure Model/1.Modeling/2.MLE No-Cure"
...
make_plot_file_base <- function(plot_type, plot_group_key) {
  if (plot_group_key == "all") {
    return(file.path(export_path, paste0("stage5_simple_lognormal_", plot_type, "_plot")))
  }
