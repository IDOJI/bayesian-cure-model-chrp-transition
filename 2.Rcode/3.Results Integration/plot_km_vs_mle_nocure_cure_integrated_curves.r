...
nocure_input_path <- Sys.getenv(
  ...
  unset = "/Users/ido/Library/CloudStorage/Dropbox/Data Analysis/Survival Analysis of CHR-P Using a Mixture Cure Model/1.Modeling/2.MLE No-Cure"
)
...
export_path <- Sys.getenv(
  ...
  unset = "/Users/ido/Library/CloudStorage/Dropbox/Data Analysis/Survival Analysis of CHR-P Using a Mixture Cure Model/2.Results Integration/km_vs_mle_nocure_cure_integrated_curves"
)

km_dataset_summary_file <- file.path(km_input_path, "stage3_simple_km_dataset_summary.csv")
km_survival_plot_file <- file.path(km_input_path, "stage3_simple_km_survival_plot.rds")
km_risk_plot_file <- file.path(km_input_path, "stage3_simple_km_risk_plot.rds")
nocure_survival_file <- file.path(nocure_input_path, "stage5_simple_lognormal_survival_estimates.csv")
nocure_risk_file <- file.path(nocure_input_path, "stage5_simple_lognormal_risk_estimates.csv")
nocure_survival_plot_file <- file.path(nocure_input_path, "stage5_simple_lognormal_survival_plot.rds")
nocure_risk_plot_file <- file.path(nocure_input_path, "stage5_simple_lognormal_risk_plot.rds")
nocure_detail_bundle_file <- file.path(nocure_input_path, "stage5_simple_lognormal_detail_plot_bundle.rds")
nocure_fitted_models_file <- file.path(nocure_input_path, "stage5_simple_lognormal_fitted_models.rds")
cure_horizon_summary_file <- file.path(cure_input_path, "stage7_simple_lognormal_mixture_cure_horizon_summary.csv")
cure_plot_source_file <- file.path(cure_input_path, "stage7_simple_lognormal_mixture_cure_plot_source.csv")
...
model_order <- c("KM", "MLE no-cure", "MLE cure")
model_palette <- c(
  "KM" = "#1B4332",
  "MLE no-cure" = "#D97706",
  "MLE cure" = "#C1666B"
...
extract_km_curve_data <- function(plot_object, value_col) {
  ...
  yearly_df <- tibble::as_tibble(plot_object$layers[[2L]]$data)
...
nocure_survival_estimates <- read_csv_checked(nocure_survival_file, "No-cure survival estimates")
nocure_risk_estimates <- read_csv_checked(nocure_risk_file, "No-cure risk estimates")
...
source_manifest <- tibble(
  source_name = c(
    ...
    "km_survival_plot",
    "km_risk_plot",
    "nocure_survival_estimates",
    "nocure_risk_estimates",
