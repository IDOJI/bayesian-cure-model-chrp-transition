...
export_path <- Sys.getenv(
  ...
  unset = "/Users/ido/Library/CloudStorage/Dropbox/Data Analysis/Survival Analysis of CHR-P Using a Mixture Cure Model/2.Results Integration/km_vs_mle_cure_integrated_curves"
)
...
mle_horizon_summary_file <- file.path(mle_input_path, "stage7_simple_lognormal_mixture_cure_horizon_summary.csv")
mle_plot_source_file <- file.path(mle_input_path, "stage7_simple_lognormal_mixture_cure_plot_source.csv")
mle_detail_annotation_file <- file.path(mle_input_path, "stage7_simple_lognormal_mixture_cure_detail_annotation_table.csv")
